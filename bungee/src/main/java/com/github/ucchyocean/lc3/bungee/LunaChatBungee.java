...
import com.github.ucchyocean.lc3.bungee.channel.BungeeChannel;
import com.github.ucchyocean.lc3.bungee.command.JapanizeCommandBungee;
...
public class LunaChatBungee extends Plugin implements PluginInterface {
    ...
    public void onEnable() {
        ...
        // ロガーの登録
        pluginLogger = new LunaChatBungeeLogger(getLogger());
    ...
    public Channel getChannel(String channelName) {
        return new BungeeChannel(channelName);
    }
