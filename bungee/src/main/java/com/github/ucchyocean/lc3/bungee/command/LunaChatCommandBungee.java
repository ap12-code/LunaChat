...
public class LunaChatCommandBungee extends Command implements TabExecutor {
    ...
    public void execute(CommandSender sender, String[] args) {
        command.execute(ChannelMemberBungee.getChannelMemberBungee(sender), "ch", args);
    }
    ...
    public Iterable<String> onTabComplete(CommandSender sender, String[] args) {
        return command.onTabComplete(ChannelMemberBungee.getChannelMemberBungee(sender), args);
    }
}
