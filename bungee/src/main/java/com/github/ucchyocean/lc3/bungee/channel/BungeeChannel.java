 ...
 */
package com.github.ucchyocean.lc3.bungee.channel;
...
public class BungeeChannel extends Channel {
     ...
     * @param name チャンネル名
     */
    public BungeeChannel(String name) {
        super(name);
    }
    ...
    protected void sendMessage(ChannelMember player, String message,
        ...
        if ( isBroadcastChannel() ) {
            ...
            for ( ProxiedPlayer p : ProxyServer.getInstance().getPlayers() ) {
                ChannelMember cp = ChannelMemberBungeePlayer.getChannelMemberBungee(p);
    ...
    public List<ChannelMember> getMembers() {
        ...
        if ( isBroadcastChannel() ) {
            ...
            for ( ProxiedPlayer p : ProxyServer.getInstance().getPlayers() ) {
                mem.add(ChannelMemberBungeePlayer.getChannelMemberBungee(p));
            }
            return mem;
        }
