...
public class MessageCommandBungee extends Command implements TabExecutor {
    ...
    public void execute(CommandSender sender, String[] args) {
        command.execute(ChannelMemberBungee.getChannelMemberBungee(sender), "m", args);
    }
    ...
    public Iterable<String> onTabComplete(CommandSender sender, String[] args) {
        return command.onTabComplete(ChannelMemberBungee.getChannelMemberBungee(sender), "m", args);
    }
}
