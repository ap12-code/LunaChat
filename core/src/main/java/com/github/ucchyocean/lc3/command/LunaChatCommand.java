...
public class LunaChatCommand {
    ...
    private final List<LunaChatSubCommand> commands;
    private final List<LunaChatSubCommand> commonCommands;
     ...
     * @return 補完候補
     */
    public List<String> onTabComplete(ChannelMember sender, String[] args) {
        if ( args.length == 1 ) {
            // コマンド名で補完する
