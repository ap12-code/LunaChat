...
public interface LunaChatAPI {
     ...
     * @return 作成されたチャンネル
     */
    Channel createChannel(String channelName, ChannelMember member);
     ...
     * @return 削除したかどうか
     */
    boolean removeChannel(String channelName, ChannelMember member);
     ...
     * @return 辞書データ
     */
    Map<String, String> getAllDictionary();
     ...
     */
    List<ChannelMember> getHidelist(ChannelMember key);
     ...
     */
    List<ChannelMember> getHideinfo(ChannelMember player);
     ...
     */
    void addHidelist(ChannelMember player, ChannelMember hided);
     ...
     */
    void removeHidelist(ChannelMember player, ChannelMember hided);
