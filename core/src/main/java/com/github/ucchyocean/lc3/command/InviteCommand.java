...
public class InviteCommand extends LunaChatSubCommand {
    ...
    private boolean runNormalInviteCommand(ChannelMember sender, String[] args) {
        ...
        // 招待相手が存在するかどうかを確認する
        ChannelMember invited = LunaChat.getChannelMember(invitedName);
     ...
     */
    @SuppressWarnings("SameReturnValue")
    private boolean runForceInviteCommand(ChannelMember sender, String[] args) {
