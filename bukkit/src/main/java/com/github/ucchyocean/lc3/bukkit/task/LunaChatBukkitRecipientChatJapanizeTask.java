 ...
 * @author ucchy
 */
public class LunaChatBukkitRecipientChatJapanizeTask extends BukkitRunnable {
     ...
     */
    public LunaChatBukkitRecipientChatJapanizeTask(String org, JapanizeType type, ChannelMember player,
